...
namespace ak
{
	...
	void LoggingSystem::postLogMessage(LogLevelFlag logLevel, const char* message)
	{
		postLogMessage(logLevel, stringToWstring(message));
	}

	void LoggingSystem::postLogMessage(LogLevelFlag logLevel, const std::string& message)
	{
		postLogMessage(logLevel, stringToWstring(message));
	}

	void LoggingSystem::postLogMessage(LogLevelFlag logLevel, const std::wstring& message)
	{
